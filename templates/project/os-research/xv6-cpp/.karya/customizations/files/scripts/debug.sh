#!/usr/bin/env bash
# Boot the xv6-cpp kernel (built with the given toolchain) in QEMU with a GDB
# stub, then connect GDB in the same terminal.
...
KERNEL_ELF="$ROOT/$BUILD_DIR/kernel"

# GDB debugs either toolchain's output equally well.
